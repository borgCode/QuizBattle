...
public enum BusinessErrorCodes {
    ...
    NOT_PLAYER_TURN(326, HttpStatus.BAD_REQUEST, "It's not player's turn"),
    MUST_WAIT_FOR_OPPONENT(327, HttpStatus.BAD_REQUEST, "Player must wait for their opponent to finish their questions"),
    MUST_ANSWER_EXISTING_QUESTIONS(328, HttpStatus.BAD_REQUEST, "Player must answer the current questions before selecting a new category"),
    INVALID_QUESTION(329, HttpStatus.BAD_REQUEST, "The question not does belong to this session"),
    QUESTION_ALREADY_ANSWERED(330, HttpStatus.BAD_REQUEST, "Player has already answered this question"),
